...
class PrimazaCluster(Cluster):
    ...
    def create_clustercontext_secret(self, secret_name: str, kubeconfig: str, namespace: str = None):
        """
        Creates the Primaza's ClusterContext secret
        """
        super().create_clustercontext_secret(secret_name, kubeconfig, self.primaza_namespace)
