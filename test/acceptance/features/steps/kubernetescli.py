...
@step(u'On Cluster "{cluster}", jsonpaths are satisfied')
def jq_is_table(context, cluster: str):
    for r in context.table:
        jq_is(context, r["jsonpath"], r["resource type"], r["name"], r["namespace"], cluster, r["value"])
