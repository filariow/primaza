...
class WorkerCluster(Cluster):
    ...
    def __allow_primaza_access_to_namespace(self, namespace: str, nstype: str, tenant: str, cluster_environment: str):
        ...
        name = f"primaza-{tenant}-{cluster_environment}"
...
def ensure_worker_cluster_running(context, cluster_name: str, ce_name: str, version: str = None, tenant: str = "primaza-system"):
