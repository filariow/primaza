Feature: Publish Service Agent to worker cluster
    ...
    Scenario: On Cluster Environment creation, Primaza Service Agent is successfully deployed to services namespace
        ...
        spec:
            ...
            - "services"
        """
        Then On Worker Cluster "worker", Primaza Service Agent for ClusterEnvironment "worker" exists into namespace "services"
    ...
    Scenario: On Cluster Environment update, Primaza Service Agent is successfully removed from service namespace
        ...
        spec:
            ...
            - services
        """
        And On Worker Cluster "worker", Primaza Service Agent for ClusterEnvironment "worker" exists into namespace "services"
        ...
        spec:
            ...
            serviceNamespaces: []
        """
        Then On Worker Cluster "worker", Primaza Service Agent for ClusterEnvironment "worker" does not exist into namespace "services"
