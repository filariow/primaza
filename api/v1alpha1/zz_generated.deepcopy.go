...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceClaimApplicationContext) DeepCopyInto(out *ServiceClaimApplicationContext) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceClaimApplicationContext.
func (in *ServiceClaimApplicationContext) DeepCopy() *ServiceClaimApplicationContext {
	if in == nil {
		return nil
	}
	out := new(ServiceClaimApplicationContext)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceClaimSpec) DeepCopyInto(out *ServiceClaimSpec) {
	*out = *in
	...
	out.ApplicationContext = in.ApplicationContext
}
