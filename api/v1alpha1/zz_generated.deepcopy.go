...
func (in *ServiceClaimStatus) DeepCopyInto(out *ServiceClaimStatus) {
	*out = *in
	if in.RegisteredService != nil {
		...
		*out = new(ServiceClaimStatusRegisteredServiceInfo)
		**out = **in
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceClaimStatusRegisteredServiceInfo) DeepCopyInto(out *ServiceClaimStatusRegisteredServiceInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceClaimStatusRegisteredServiceInfo.
func (in *ServiceClaimStatusRegisteredServiceInfo) DeepCopy() *ServiceClaimStatusRegisteredServiceInfo {
	if in == nil {
		return nil
	}
	out := new(ServiceClaimStatusRegisteredServiceInfo)
