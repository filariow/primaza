...
import (
	"github.com/primaza/primaza/api/v1alpha1/formatters"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceClaimFormatter) DeepCopyInto(out *ServiceClaimFormatter) {
	*out = *in
	if in.JSONFormatter != nil {
		in, out := &in.JSONFormatter, &out.JSONFormatter
		*out = new(formatters.JSONFormatter)
		(*in).DeepCopyInto(*out)
	}
	if in.GoTemplateFormatter != nil {
		in, out := &in.GoTemplateFormatter, &out.GoTemplateFormatter
		*out = new(formatters.GoTemplateFormatter)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceClaimFormatter.
func (in *ServiceClaimFormatter) DeepCopy() *ServiceClaimFormatter {
	if in == nil {
		return nil
	}
	out := new(ServiceClaimFormatter)
	in.DeepCopyInto(out)
	return out
}
